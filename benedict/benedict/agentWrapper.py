...
class TreasonAgentWrapper:
    ...
    def registerCallbacks(self, *,
                          ...
                          onLeaveGame: Callable[["TreasonAgentWrapper"], None] = None):
        self._onJoinGameCallback = onJoinGame
        self._onLeaveGameCallback = onLeaveGame
    ...
    def connect(self, address: str, onRegister: Callable[[str], None] = None):
    ...
    def createGame(self, onCreatedGame: Callable[[str], None] = None):
        if self._playerId is None:
